module app {
    const main = angular.module('formulaApp', ['ngRoute', 'common.services']);

    main.config(routeConfig);

    routeConfig.$inject = ['$routeProvider', '$locationProvider'];
    function routeConfig($routeProvider: ng.route.IRouteProvider, $locationProvider: { hashPrefix: (arg0: string) => void; }): void {
